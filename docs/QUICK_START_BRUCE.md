...
**Problem:** Script permission denied (Linux/macOS)
- **Solution:** Run `chmod +x install-bruce-sideload.sh`

**Problem:** Installation script can't find files
- **Solution:** Run script from project root directory where `platformio.ini` is located
